        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserEntityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "ChatRooms",
                columns: new[] { "Id", "AppUserEntityId", "DateCreated", "RoomName" },
                values: new object[] { 1001, null, new DateTime(2022, 9, 7, 14, 25, 54, 563, DateTimeKind.Utc).AddTicks(1842), "General" });

            migrationBuilder.InsertData(
                table: "ChatRooms",
                columns: new[] { "Id", "AppUserEntityId", "DateCreated", "RoomName" },
                values: new object[] { 1002, null, new DateTime(2022, 9, 7, 14, 25, 54, 563, DateTimeKind.Utc).AddTicks(1845), "Coding" });
